            ...
            <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
              <div class="card">
                <div class="header">
                  ...
                  <div class="content">
                    <form  class="text-center border border-light p-5" action="reporte_centros.php"   method="POST">
                      
                      <h3 style="color: red">GENERAR REPORTE CENTROS</h3>
                          ...
                          <div class="col-md-12">
                              <div class="card">
                                  ...
                                  <div class="content table-responsive table-full-width">
                                      ...
                                      summary="Code page support in different versions of MS Windows." rules="groups" frame="hsides" ><caption>REPORTE CENTROS</caption>
                                      ...
                                      <thead>
                                          <tr style="color:black;">
                                                  ...
                                                  if(isset($_POST['btn1'])){ 
                                                          ...
                                                          $cap=$_POST['id_cap'];
                                                          $sql="CALL reportes('$inicio','$final','$cap');"; 
